...
export type MeQuery = {
  ...
  me: {
    ...
    badges: Array<{ __typename?: "Badge"; name: string; image: string; dateAssigned?: string | null; description?: string | null }>;
  };
};
            ...
            selectionSet: {
              ...
              selections: [
                ...
                },
                {
                  ...
                  selectionSet: { kind: "SelectionSet", selections: [{ kind: "Field", name: { kind: "Name", value: "html" } }] },
                },
                {
                  kind: "Field",
